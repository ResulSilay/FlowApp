...
namespace FlowApp.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "FlowApp API", Version = "v1" });
            });
        }
        ...
        public void Configure(IApplicationBuilder app, IHostEnvironment env)
        {
            ...
            {
                c.RoutePrefix = "";
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "FlowApp V1");
            });
        }
    }
}
